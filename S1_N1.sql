...
SELECT DISTINCT(company.country) as 'Països que compren'
FROM company
JOIN transaction
...
ORDER BY 2 DESC
LIMIT 1;
# Comprovo ampliant el limit a 3 que no es repeteixen valors de despesa mitjana
# i, per tant, l'empresa amb major despesa mitjana es Eget Ipsum Ltd.
